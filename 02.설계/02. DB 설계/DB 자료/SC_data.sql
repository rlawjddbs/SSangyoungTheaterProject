...
values (movie_code,'극한직업','extreme_job.png','다큐멘터리','대한민국','이병헌','PG','111',
...
(movie_code, movie_title, movie_img, genre, country, director, movie_grade, runningtime,
playdate, synopsis, actor, movie_date, admin_id)
values (movie_code,'뺑반','hit_and_run.png','범죄,액션','대한민국','한준희','PG','133',
...
(movie_code, movie_title, movie_img, genre, country, director, movie_grade, runningtime,
playdate, synopsis, actor, movie_date, admin_id)
values (movie_code,'말모이','the_secret_mission.png','드라마','대한민국','엄유나','PG','135',
...
values('까나리카노',3500,'gganaricano.png','먹으면 잠이 안 깰 수가 없다!!', '2018-01-24','Y');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('츄러스',3000,'churros.png','은은한 시나몬향과 너무 달지않은 맛이 환상! 아메리카노+츄러스 먹어볼래요?', '2019-02-18');

commit;

--------------------------Data for table snack_sale--------------------------------
insert into snack_sale(snack_order_num, quan, check_exchange, snack_sale_date, snack_name, member_id)
values('SOR_01231901', 2, 'Y', to_date('2019-01-23 15:15:15','yyyy-mm-dd hh24:mi:ss'), '콜라','seojin2');
insert into snack_sale(snack_order_num, quan, check_exchange, snack_sale_date, snack_name, member_id)
values('SOR_01291902', 4, 'Y', to_date('2019-01-29 12:20:35','yyyy-mm-dd hh24:mi:ss'), '카라멜팝콘','doctor_seul');
insert into snack_sale(snack_order_num, quan, check_exchange, snack_sale_date, snack_name, member_id)
values('SOR_01291903', 1, 'N', to_date('2019-01-29 16:37:15','yyyy-mm-dd hh24:mi:ss'), '맥반석오징어','');
insert into snack_sale(snack_order_num, quan, check_exchange, snack_sale_date, snack_name, member_id)
values('SOR_01301904', 2, 'N', to_date('2019-01-30 11:19:49','yyyy-mm-dd hh24:mi:ss'), '나쵸','');
insert into snack_sale(snack_order_num, quan, check_exchange, snack_sale_date, snack_name, member_id)
values('SOR_01301905', 1, 'N', to_date('2019-01-30 11:31:24','yyyy-mm-dd hh24:mi:ss'), '카라멜팝콘','');
insert into snack_sale(snack_order_num, quan, check_exchange, snack_sale_date, snack_name, member_id)
values('SOR_01241906', 3, 'Y', to_date('2019-01-24 20:20:35','yyyy-mm-dd hh24:mi:ss'), '나쵸','mamasang');
