...
values('N_1901290830', '20190129', '0830', '1045', 'M_000013', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901291045', '20190129', '1045', '1300', 'M_000013', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901291300', '20190129', '1300', '1440', 'M_000014', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901291440', '20190129', '1440', '1650', 'M_000011', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901291650', '20190129', '1650', '1911', 'M_000008', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901291911', '20190129', '1911', '2132', 'M_000008', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901292132', '20190129', '2132', '0117', 'M_000008', 'N');

insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901290830', '20190129', '0830', '1045', 'M_000013', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901291045', '20190129', '1045', '1300', 'M_000013', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901291300', '20190129', '1300', '1440', 'M_000014', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901291440', '20190129', '1440', '1650', 'M_000011', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901291650', '20190129', '1650', '1911', 'M_000008', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901291911', '20190129', '1911', '2132', 'M_000008', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901292132', '20190129', '2132', '0117', 'M_000008', 'P');

insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901300900', '20190130', '0900', '1140', 'M_000014', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901301140', '20190130', '1140', '1350', 'M_000014', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901301350', '20190130', '1350', '1604', 'M_000012', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901301604', '20190130', '1604', '1847', 'M_000010', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901301847', '20190130', '1847', '2130', 'M_000010', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901302130', '20190130', '2130', '2344', 'M_000012', 'N');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('N_1901302344', '20190130', '2344', '0203', 'M_000008', 'N');

insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901300900', '20190130', '0900', '1140', 'M_000014', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901301140', '20190130', '1140', '1350', 'M_000014', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901301350', '20190130', '1350', '1604', 'M_000012', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901301604', '20190130', '1604', '1847', 'M_000010', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901301847', '20190130', '1847', '2130', 'M_000010', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901302130', '20190130', '2130', '2344', 'M_000012', 'P');
insert into on_screen(screen_num, screen_date, start_time, end_time, movie_code, screen_name)
values('P_1901302344', '20190130', '2344', '0203', 'M_000008', 'P');
...
values(11,'NM_000008055');

insert into standard_seat(seat_num, book_number)
values(12,'NM_000008055');

insert into standard_seat(seat_num, book_number)
values(5,'NM_000014062');

insert into standard_seat(seat_num, book_number)
values(6,'NM_000014062');

commit;

--------------------------Data for table primium_seat------------------------------
insert into primium_seat(seat_num, book_number)
values(10,'NM_000013063');

insert into primium_seat(seat_num, book_number)
values(11,'NM_000013063');

insert into primium_seat(seat_num, book_number)
values(19,'NM_000013064');

insert into primium_seat(seat_num, book_number)
values(20,'NM_000013064');

commit;

--------------------------Data for table rating------------------------------------
insert into rating(book_number, movie_rate, review, member_id)
values('NM_000013064',8,'보통사람의 작은힘이모여 큰뜻을 이루는 우리이야기 독립이 총칼로만 하는게 아니라 우리가모여 우리의 말과 글로 할수있다는거 일깨워준다. 너무 감명깊다!!','stealjam');

insert into rating(book_number, movie_rate, review, member_id)
values('NM_000008055',7,'가볍게 보기 좋은 영화인거같아요~~ 웃으면서 보고 나왔네요 ㅎㅎ','harvard17');

insert into rating(book_number, movie_rate, review, member_id)
values('NM_000014059',10,'작은 찻잔과 좁은 다실 안에 계절과 세월 그리고 인생과 성장을 차곡차곡 쌓아올린 영화... 키키 키린님의 극중 대사들이 마치 마지막 작별인사인 듯 해서 너무 슬프네요ㅠㅠ','mamasang');
...
insert into rating (book_number, movie_rate, review, member_id)
values('NM_000008057', 8, '러닝 타임 내내 웃으며 스트레스 날려버릴 수 있는 영화입니다!! 뻔한 코미디 영화일까봐 볼까 말까 고민하시는 분들, 그냥 믿고 보셔도 후회 없으실거라고 생각합니다~! 쬰잼!','jjini83');
...
values('카라멜팝콘',6000,'caramel_popcorn.jpg','달콤한 카라멜 향이 가득한 카라멜팝콘을 즐겨보세요!', '2016-08-14');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('콜라',2000,'cola.png','언제 어디서나 이 맛, 이 느낌!', '2017-04-25');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('고소팝콘',5000,'normal_popcorn.jpg','옥수수 본연의 맛을 즐길 수 있는 짭짜름한 클래식 고소팝콘!', '2018-05-12');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('나쵸',4500,'nacho.jpg','바삭바삭한 나쵸에 칠리치즈 조합, 여기가 바로 멕시코!?', '2018-01-08');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('맥반석오징어',7000,'grilled_squid.jpg','씹고 뜯고 맛보고 즐기고~!', '2019-01-24');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('물',2000,'water.png','아무것도 싫은 당신, 물이라도 드시옵소서', '2018-06-04');
insert into snack(snack_name, snack_price, snack_img, snack_info, snack_date)
values('아메리카노',3500,'americano.jpg','졸지말고 커피 한 잔', '2019-01-02');

commit;

--------------------------Data for table snack_sale--------------------------------
insert into snack_sale(snack_order_num, quan, exchange, snack_name, member_id)
values('SOR_01231901', 2, 'Y','콜라','seojin2');
insert into snack_sale(snack_order_num, quan, exchange, snack_name, member_id)
values('SOR_01281902', 4, 'Y','카라멜팝콘','doctor_seul');
insert into snack_sale(snack_order_num, quan, exchange, snack_name, member_id)
values('SOR_01031903', 1, 'N','맥반석오징어','');
insert into snack_sale(snack_order_num, quan, exchange, snack_name, member_id)
values('SOR_01141904', 2, 'N','나쵸','');
insert into snack_sale(snack_order_num, quan, exchange, snack_name, member_id)
values('SOR_01111905', 1, 'N','카라멜팝콘','');
insert into snack_sale(snack_order_num, quan, exchange, snack_name, member_id)
values('SOR_01191906', 3, 'Y','나쵸','mamasang');
